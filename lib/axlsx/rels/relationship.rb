module Axlsx
  ...
  class Relationship
    ...
    def to_xml_string(str = '')
      h = instance_values.reject { |k, _| k == 'source_obj' }
      str << '<Relationship '
    ...
    def should_use_same_id_as?(other)
      result = source_obj == other.source_obj && self.Type == other.Type && self.TargetMode == other.TargetMode
      result &&= self.Target == other.Target if self.TargetMode == :External
      result
    end
  end
end
