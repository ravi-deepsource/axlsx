module Axlsx
  ...
  class DLbls
    ...
    def initialize(chart_type, options = {})
      unless [Chart, LineChart].include?(chart_type.superclass)
        raise ArgumentError, 'chart_type must inherit from Chart'
      end
    ...
    def initialize_defaults
      %i[show_legend_key show_val show_cat_name
    ...
    def d_lbl_pos=(label_position)
      ...
      Axlsx::RestrictionValidator.validate 'DLbls#d_lbl_pos', %i[bestFit b ctr inBase inEnd l outEnd r t], label_position
