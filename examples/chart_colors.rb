...
wb.add_worksheet(name: 'Bar Chart') do |sheet|
  ...
  sheet.add_row %w[First Second Third]
  sheet.add_row [1, 2, 3.5]
  sheet.add_chart(Axlsx::Bar3DChart, start_at: 'A4', end_at: 'F17', title: sheet['A1']) do |chart|
    chart.add_series data: sheet['A3:C3'], labels: sheet['A2:C2'], colors: %w[FF0000 00FF00 0000FF], color: '000000'
...
wb.add_worksheet(name: 'Hard Bar Chart') do |sheet|
  sheet.add_chart(Axlsx::Bar3DChart, start_at: 'A4', end_at: 'F17', title: 'hard code chart') do |chart|
    chart.add_series data: [1, 3, 5], labels: %w[a b c], colors: %w[FF0000 00FF00 0000FF]
    chart.valAxis.label_rotation = -45
    chart.catAxis.label_rotation = 45
  end
end
...
wb.add_worksheet(name: 'Pie Chart') do |sheet|
  sheet.add_row %w[First Second Third Fourth]
  sheet.add_row [1, 2, 3, '=PRODUCT(A2:C2)']
  sheet.add_chart(Axlsx::Pie3DChart, start_at: [0, 2], end_at: [5, 15], title: 'example 3: Pie Chart') do |chart|
    chart.add_series data: sheet['A2:D2'], labels: sheet['A1:D1'], colors: %w[FF0000 00FF00 0000FF 000000]
  end
end
