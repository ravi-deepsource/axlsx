...
class TestValidators < Test::Unit::TestCase
  ...
  def test_validators
    ...
    %i[information stop warning].each do |sym|
    ...
    %i[lessThan lessThanOrEqual equal notEqual greaterThanOrEqual greaterThan between notBetween].each do |sym|
    ...
    %i[custom data decimal list none textLength time whole].each do |sym|
    ...
    # sheet_view_type
    %i[normal page_break_preview page_layout].each do |sym|
    ...
    # active_pane_type
    %i[bottom_left bottom_right top_left top_right].each do |sym|
    ...
    # split_state_type
    %i[frozen frozen_split split].each do |sym|
    ...
    # view_visibility
    %i[visible hidden very_hidden].each do |sym|
    ...
    # marker_symbol
    %i[default circle dash diamond dot picture plus square star triangle x].each do |sym|
  ...
  def test_validate_u
    ...
    %i[none single double singleAccounting doubleAccounting].each do |sym|
