...
class TestPackage < Test::Unit::TestCase
  def setup
    ...
    ws.add_chart(Axlsx::Pie3DChart, title: 'これは？', start_at: [0, 3]) do |chart|
      chart.add_series data: [1, 2, 3], labels: %w[a b c]
    ...
    img = File.expand_path('../examples/image1.jpeg', __dir__)
    ...
    ws.add_image image_src: File.expand_path('../examples/image1.gif', __dir__) do |image|
      image.start_at 0, 20
      image.width = 360
      image.height = 333
    end
    ws.add_image image_src: File.expand_path('../examples/image1.png', __dir__) do |image|
      image.start_at 9, 20
      image.width = 180
      image.height = 167
    end
